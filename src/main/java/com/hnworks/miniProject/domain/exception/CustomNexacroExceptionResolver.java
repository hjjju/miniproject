package com.hnworks.miniProject.domain.exception;
...
import com.nexacro.uiadapter.spring.core.view.NexacroView;
	/* 
	* FUNCTION NAME : CustomNexacroExceptionResolver
	* DESCRIPTION   :nexacro platform 요청에 대한 예외 발생 시 처리되는ModelAndView doResolveException 이다.
	* PARAM 		  : param1 조회 객체1 x
	*			      : param2 조회 객체2 x
	*/
	public class CustomNexacroExceptionResolver extends AbstractHandlerExceptionResolver {
